...
class RegisterView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # 校验邮箱
        if not re.match(r'^[a-z0-9][\w.\-]*@[a-z0-9\-]+(\.[a-z]{2,5}){1,'
                        r'2}$', email):
        ...
        # 发邮件
        # subject = "Rich Studio欢迎信息"
        # message = ""
        # sender = settings.EMAIL_FROM
        # receiver = [email]
        # html_message = "<h1>%s,欢迎您成为Rich Studio会员</h1>请点击下面链接激活您的账户:<br/><a " \
        #                "href='http://pythoncc.work:13579" \
        #                "/user/active/%s'>pythoncc.work:13579" \
