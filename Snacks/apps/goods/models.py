...
class GoodsType(BaseModel):
    """商品类型模型类"""
    name = models.CharField(max_length=20, verbose_name="牌子名称")
    # logo = models.CharField(max_length=20, verbose_name="标志")
...
class GoodsSKU(BaseModel):
    ...
    goods = models.ForeignKey("Goods", verbose_name="具体商品名称", on_delete=models.CASCADE)
    name = models.CharField(max_length=20, verbose_name="商品名称")
    desc = models.CharField(max_length=256, verbose_name="商品简介")
    price = models.DecimalField(max_digits=10, decimal_places=2,
                                verbose_name='商品价格')
    unite = models.CharField(max_length=20, default='500g',verbose_name='商品单位')
...
class IndexPromotionBanner(BaseModel):
    ...
    url = models.CharField(verbose_name='活动链接', max_length=255)
